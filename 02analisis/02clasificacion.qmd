...
area_estudio_sf <- st_read("../01entrada/subsubcuencaAconcagua05420.shp") |>
  select("COD_SSUBC")|>
  st_transform(area_estudio_sf, crs = 4326)
...
nubosidad_max <- 100 # Porcentaje maximo de nubosidad permitido
...
### 3. Clasificación supervisada con poligonos de entrenamiento
...
### 4. Evaluación de la clasificacion
